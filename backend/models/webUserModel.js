 ...
 */
 WebUserSchema.statics.authenticate = async function (email, password) {
 ...
 */
 WebUserSchema.statics.insert = async function (accountData) {
  const account = new WebAccount(accountData)
  return account.save()
}

// Create a model using the schema.
export const WebAccount = mongoose.model('WebUser', WebUserSchema)